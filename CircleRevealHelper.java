...
public class CircleRevealHelper {
    ...
    public  void circularReveal(int centerX, int centerY, float startRadius, float endRadius, long duration, Interpolator interpolator) {
        ...
        //i add this lines of codes according to this link because canvans.clipath is deprecated
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isCircularReveal) {
            ...
            //i commented the link below and replace try catch method instead
            // because canvans.clipath is deprecated according to this link
            //https://stackoverflow.com/questions/8895677/work-around-canvas-clippath-that-is-not-supported-in-android-any-more
